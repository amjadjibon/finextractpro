    ...
    try {
      ...
      if (error) {
        ...
        if (data.user.email_confirmed_at) {
          // User is immediately confirmed (in development or if confirmation is disabled)
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="text-center">
        ...
        <CardDescription>Sign up to start using FinExtractPro</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="text-center text-sm text-gray-500">
          <p>Already have an account? <Link href="/auth/signin" className="font-medium text-primary hover:underline">Sign in</Link></p>
        </div>
